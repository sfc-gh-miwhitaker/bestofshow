...
SELECT 'Tables' AS object_type, COUNT(*) AS count FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'EVENT_INTELLIGENCE'
UNION ALL SELECT 'Views', COUNT(*) FROM INFORMATION_SCHEMA.VIEWS WHERE TABLE_SCHEMA = 'EVENT_INTELLIGENCE'
UNION ALL SELECT 'Dynamic Tables', COUNT(*) FROM INFORMATION_SCHEMA.DYNAMIC_TABLES WHERE SCHEMA_NAME = 'EVENT_INTELLIGENCE';
